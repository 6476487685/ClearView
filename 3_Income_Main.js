...
function awaitBackupAndDownload(){
  try{
    ...
    if(unifiedStr){ const u=JSON.parse(unifiedStr); addMasterSheets(u.task); addMasterSheets(u.expense); addMasterSheets(u.income); addMasterSheets(u.investment); addMasterSheets(u.common); }
