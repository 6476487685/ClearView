  ...
  async function showFolderChoiceDialog(folderPath, folderType) {
    ...
    modal.innerHTML = `
      <div style="text-align: center; margin-bottom: 24px;">
        ...
        <h3 style="margin: 0 0 8px 0; color: var(--text-primary); font-size: 20px; font-weight: 700;">
      ...
      <div style="margin-bottom: 24px;">
        ...
        <div style="display: flex; flex-direction: column; gap: 12px;">
          ...
          <button id="chooseNewFolderBtn" style="
            width: 100%; padding: 14px 18px; background: var(--warning); color: #fff; border: none;
            border-radius: 10px; font-weight: 600; cursor: pointer; transition: all 0.3s ease;
          ...
          <button id="cancelFolderChoiceBtn" style="
            width: 100%; padding: 14px 18px; background: var(--text-secondary); color: #fff; border: none;
            border-radius: 10px; font-weight: 600; cursor: pointer; transition: all 0.3s ease;
